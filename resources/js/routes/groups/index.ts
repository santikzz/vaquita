...
/**
* @see \App\Http\Controllers\MemberController::leave
 * @see app/Http/Controllers/MemberController.php:54
 * @route '/groups/{group}/leave'
 */
export const leave = (args: { group: string | { uuid: string } } | [group: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
 ...
 * @route '/groups/{group}/leave'
 */
leave.url = (args: { group: string | { uuid: string } } | [group: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { group: args }
    }
 ...
 * @route '/groups/{group}/leave'
 */
leave.post = (args: { group: string | { uuid: string } } | [group: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: leave.url(args, options),
    method: 'post',
})
const groups = {
...
quick: Object.assign(quick, quickA86127),
